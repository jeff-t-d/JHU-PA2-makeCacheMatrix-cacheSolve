...
can be looked up in the cache rather than recomputed. This function
takes advantage of the lexical scoping rules of R and how they can be
...
not discuss here). This pair of functions will cache the inverse of a matrix.
